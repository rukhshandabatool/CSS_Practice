...
Colors, borders, margins, and paddings

Fonts, text properties, and basic selectors
...
Backgrounds, opacity, and transparency

Navbar and content styling

Basic hover and button effects
...
Each level represents my hands-on journey — learning, implementing, and experimenting with various CSS properties to build a solid visual design foundation.
